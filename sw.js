const CACHE='tabkhat-v27';
const CORE=['./','./index.html','./styles.css?v=27','./recipes.js?v=27','./app.js?v=27','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png','./sitemap.xml','./robots.txt'];
