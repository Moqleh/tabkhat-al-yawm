const CACHE='tabkhat-v19';
const CORE=['./','./index.html','./styles.css?v=19','./recipes.js?v=19','./app.js?v=19','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-stable.webp'];
