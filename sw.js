const CACHE='tabkhat-v33';
const CORE=['./','./index.html','./styles.css?v=39','./recipes.js?v=37','./app.js?v=38','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png?v=28','./sitemap.xml','./robots.txt'];
