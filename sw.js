const CACHE='tabkhat-v28';
const CORE=['./','./index.html','./styles.css?v=28','./recipes.js?v=28','./app.js?v=28','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png?v=28','./sitemap.xml','./robots.txt'];
