const CACHE='tabkhat-v29';
const CORE=['./','./index.html','./styles.css?v=29','./recipes.js?v=29','./app.js?v=29','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png?v=28','./sitemap.xml','./robots.txt'];
