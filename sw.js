const CACHE='tabkhat-v31';
const CORE=['./','./index.html','./styles.css?v=37','./recipes.js?v=30','./app.js?v=35','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png?v=28','./sitemap.xml','./robots.txt'];
