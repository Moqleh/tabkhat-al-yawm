const CACHE='tabkhat-v22';
const CORE=['./','./index.html','./styles.css?v=22','./recipes.js?v=22','./app.js?v=22','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png'];
