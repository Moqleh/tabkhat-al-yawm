const CACHE='tabkhat-v30';
const CORE=['./','./index.html','./styles.css?v=36','./recipes.js?v=29','./app.js?v=34','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png?v=28','./sitemap.xml','./robots.txt'];
