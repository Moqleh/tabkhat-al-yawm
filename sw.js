const CACHE='tabkhat-v32';
const CORE=['./','./index.html','./styles.css?v=37','./recipes.js?v=36','./app.js?v=36','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png?v=28','./sitemap.xml','./robots.txt'];
