const CACHE='tabkhat-v21';
const CORE=['./','./index.html','./styles.css?v=21','./recipes.js?v=21','./app.js?v=21','./manifest.webmanifest','./icon.svg','./assets/chef-mo-logo-original.png'];
